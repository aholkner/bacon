...
glyph_layout = bacon.GlyphLayout(runs, bacon.window.width / 2, bacon.window.height / 2, align=bacon.Alignment.center, vertical_align=bacon.VerticalAlignment.center)
